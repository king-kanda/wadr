    ...
    <main>
        <section className={`  bg-purple py-8`}>
              ...
              <div className="hero-body container p-5 md:p-24">
                <div className="border-l-8 border-white px-20 md:py-6">
              ...
              <div className="brief">
                <div className="container p-5 md:px-24">
                  <div className="md:grid grid-cols-2 gap-6 items-center">
                    <div className={`col-span-1 ${styles.aboutTt} ml-24`}>
                        <h2 className={` text-purple bg-white py-2 px-6 w-2/5 text-center `}>
                          About Us 
                        </h2>
                    ...
                    <div className={`col-span-1 ${styles.aboutText} text-end `}>
        ...
        <section className={` ${styles.aboutSec} bg-gray-1`}>
              <div className="container py-12 px-24 ">
                <div className="grid grid-cols-2 gap-5 px-6 mt-6 items-center">
                  <div className="image-section grid grid-cols-2 gap-3">
                  ...
                  <div className={` ${styles.textSection} text-end px-6`}>
                      <h2>
                        Our Mission ,<br /> Vission & Beliefs.
                      </h2>

                      <div className="text-start px-12 py-6">
                          <h3>
                            Our Mission
                          </h3>
                          <p>
        ...
        <section className={` ${styles.Team} p-12`}>
          <div className="container">
            <div className="md:grid grid-cols-3 gap-5 px-6  items-start">
